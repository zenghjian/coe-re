...
class CoeModel(BaseModel):
    ...
    def feed_data(self, data):
        ...
        if 'descriptor' in data_x:
            ...
            descriptors_x = compute_wks_autoscale(eVals_x.unsqueeze(0), eVecs_x.unsqueeze(0), 
                                                 Ms_x.unsqueeze(0), n_descr=128)
            descriptors_y = compute_wks_autoscale(eVals_y.unsqueeze(0), eVecs_y.unsqueeze(0), 
